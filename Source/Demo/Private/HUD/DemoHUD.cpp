...
void ADemoHUD::AddCharacterOverlay()
{
...
void ADemoHUD::DrawHUD()
{
	...
	if (GEngine)
	{
		...
		{
			FVector2D Spread(0.f, -SpreadScaled); // negative dir going up
...
void ADemoHUD::DrawCrosshair(UTexture2D* Texture, FVector2D ViewportCenter, FVector2D Spread, FLinearColor Color)
{
